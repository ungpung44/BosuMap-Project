    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            <%
                ...
                String password = request.getParameter("reply_password");
                ...
                String sql = "INSERT INTO Reply(con_num, id, content, date, pw) VALUES(?, ?, ?, now(), ?)";
            ...
            %>
            alert("댓글 등록 완료!");
            location.href="${pageContext.request.contextPath}/jsp/logined/boardView.jsp?name=<%=name%>&&uid=<%=uid%>";
        </script>
    </head>
    <body>
        <!-- Top Bars -->
