    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            <%
                ...
                String boardTi = request.getParameter("title");
                String boardCo = request.getParameter("content");
                ...
                String sql = "INSERT INTO board(title, contents, created_datetime, creator_id, password) values(?, ?, now(), ?, ?)";
                connection = DriverManager.getConnection(url, user, pass);
                pstmt = connection.prepareStatement(sql);
                pstmt.setString(1, boardTi);
                pstmt.setString(2, boardCo);
                ...
                connection.close();
            %>
                alert("글 등록을 완료하였습니다! 글 목록으로 이동합니다!");
