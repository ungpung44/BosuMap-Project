    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            if(resultSetName.length == 0){
                alert("일치하는 결과가 없습니다.");
                location.href="${pageContext.request.contextPath}/jsp/program.jsp";
            }
        </script>
    </head>
    <body>
        ...
        <div class="container">
            <form action="${pageContext.request.contextPath}/jsp/programMapPage.jsp" method="post" class="form_list">
                <div class="div_title">
                    <h1>식당 리스트</h1>
                </div>
            </form>
